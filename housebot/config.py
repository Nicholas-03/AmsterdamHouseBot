...
PARARIUS_EMAIL = _getenv_fallback("PARARIUS_EMAIL", KAMERNET_EMAIL or FUNDA_EMAIL or HOUSING_EMAIL).strip()
...
PARARIUS_ALERT_MONITOR_ENABLED = _parse_bool(
    os.getenv("PARARIUS_ALERT_MONITOR_ENABLED"),
    bool(CLOUDFLARE_MAILBOX_API_BASE and CLOUDFLARE_MAILBOX_API_TOKEN),
)
PARARIUS_ALERT_MONITOR_INTERVAL_SECONDS = _parse_non_negative_int(
    os.getenv("PARARIUS_ALERT_MONITOR_INTERVAL_SECONDS"),
    60,
)
PARARIUS_ALERT_MAILBOX_MAX_RESULTS = _parse_non_negative_int(
    os.getenv("PARARIUS_ALERT_MAILBOX_MAX_RESULTS"),
    50,
)
